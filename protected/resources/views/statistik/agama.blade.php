        ...
        <div class="col-xs-6 pull-right">
         ...
         <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <h5> Data Penduduk</h5>
              <h6> Kristen : <b>{{ $dkristen }}</b></h6>
              <h6> Katolik : <b>{{ $dkatolik }}</b></h6>
              <h6> Islam : <b>{{ $dislam }}</b></h6>
              <h6> Budha : <b>{{ $dbudha }}</b></h6>
              <h6> Hindu : <b>{{ $dhindu }}</b></h6>
      ...
      <div class="modal fade" id="modal-export-kelurahan">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form action="{{ route('statistik.agamaa') }}" method="POST" enctype="multipart/form-data">
...
<script>
  $(function () {
    ...
    var areaChartData = {
      labels  : ['Kristen', 'Katolik', 'Islam', 'Budha', 'Hindu'],
      datasets: [
        {
          label               : 'Electronics',
          fillColor           : '#00c0ef',
