...
<section class="content-header">
      <h1>
        Statistik
        <small>Statistik Jenis Kelamin</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-6 pull-right">
         ...
         <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <h5> Data Penduduk</h5>
              <h6> Laki - laki : <b>{{ $dsatu }}</b></h6>
              <h6> Perempuan : <b>{{ $ddua }}</b></h6>
      ...
      <div class="modal fade" id="modal-export-kelurahan">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form action="{{ route('statistik.jkk') }}" method="POST" enctype="multipart/form-data">
