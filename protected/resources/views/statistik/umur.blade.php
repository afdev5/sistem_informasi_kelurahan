        ...
        <div class="col-xs-6 pull-right">
         ...
         <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Statistik Usia (%)</h3>
            </div>
            <div class="box-body">
        ...
        <div class="col-xs-6 pull-right">
         ...
         <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <h5> Data Penduduk</h5>
              <h6> 0 - 16 Tahun : <b>{{ $dsatu }}</b></h6>
              <h6> 17 - 35 Tahun : <b>{{ $ddua }}</b></h6>
              <h6> 36 - 50 Tahun : <b>{{ $dtiga }}</b></h6>
              <h6> 51 - 65 Tahun : <b>{{ $dempat }}</b></h6>
              <h6> Lebih dari 65 Tahun : <b>{{ $dlima }}</b></h6>
      ...
      <div class="modal fade" id="modal-export-kelurahan">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form action="{{ route('statistik.usiaa') }}" method="POST" enctype="multipart/form-data">
...
<script>
  $(function () {
    ...
    var areaChartData = {
      labels  : ['0 - 16 Tahun', '17 - 35 Tahun', '36 - 50 Tahun', '51 - 65 Tahun', 'Lebih dari 65 Tahun'],
      datasets: [
        {
          label               : 'Electronics',
          fillColor           : '#00c0ef',
