            ...
            <form role="form" method="POST" action="{{ route('kelurahan.store') }}">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control{{ $errors->has('kelurahan') ? ' is-invalid' : '' }}" id="kelurahan" name="kelurahan" value="{{ old('kelurahan') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control{{ $errors->has('kode_pos') ? ' is-invalid' : '' }}" id="kode_pos" name="kode_pos" value="{{ old('kode_pos') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control{{ $errors->has('alamat_kantor') ? ' is-invalid' : '' }}" id="alamat_kantor" name="alamat_kantor" value="{{ old('alamat_kantor') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control{{ $errors->has('no_telp') ? ' is-invalid' : '' }}" id="no_telp" name="no_telp" value="{{ old('no_telp') }}">
