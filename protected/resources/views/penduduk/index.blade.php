...
@else
    ...
    <section class="content-header">
      <h1>
      Penduduk
        <small> Data Penduduk Kelurahan {{ Auth::user()->kelurahan['kelurahan'] }}</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Penduduk</li>
    ...
    <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <!-- <h3 class="box-title">Hover Data Table</h3> -->
              <a href="{{ route('penduduk.create') }}" class="btn btn-success">Tambah Penduduk</a>
              <div class="btn-group">
                  <!-- <button type="button" class="btn btn-info">Export/Import</button> -->
                  <a href="#" class="btn btn-info"><i class="fa fa-file-excel-o"></i> Export/Import</a>
                  <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="{{ route('penduduk.export') }}">Export ke Excel</a></li>
                    <li><a href="#" data-toggle="modal" data-target="#modal-export">Import dari Excel</a></li>
                  </ul>
                </div>
            </div>
            <!-- /.box-header -->
