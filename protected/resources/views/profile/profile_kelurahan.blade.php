...
<!-- Content Header (Page header) -->
    ...
    <div class="row">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{ route('profile_kelurahan.update', $data->id) }}">
                @csrf
            <input type="hidden" name="_method" value="PATCH">
              <div class="box-body">
                <div class="form-group">
                  <label for="kec">Kecamatan</label>
                  <input type="text" class="form-control{{ $errors->has('kec') ? ' is-invalid' : '' }}" id="kec" value="{{ $data->kecamatan['kecamatan'] }}" readonly>
                  @if ($errors->has('kec'))
