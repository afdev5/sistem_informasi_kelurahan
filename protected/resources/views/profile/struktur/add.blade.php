...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
      Kelurahan
        <small>Tambah Struktur Kelurahan</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header --> 
            <!-- form start -->
            <form role="form" method="POST" action="{{ route('struktur_kelurahan.store') }}" enctype="multipart/form-data">
                @csrf
              <div class="box-body">
                <div class="form-group">
                  <label for="nama_pegawai">Nama Pegawai</label>
                  <input type="text" class="form-control{{ $errors->has('nama_pegawai') ? ' is-invalid' : '' }}" id="nama_pegawai" name="nama_pegawai" value="{{ old('nama_pegawai') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control{{ $errors->has('nip_pegawai') ? ' is-invalid' : '' }}" id="nip_pegawai" name="nip_pegawai" value="{{ old('nip_pegawai') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control{{ $errors->has('agama') ? ' is-invalid' : '' }}" id="agama" name="agama" value="{{ old('agama') }}">
                  @if ($errors->has('agama'))
                        <span class="invalid-feedback" role="alert">
