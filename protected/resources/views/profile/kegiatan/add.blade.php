...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
      Kelurahan
        <small>Tambah Kegiatan Kelurahan</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{ route('kegiatan_kelurahan.store') }}" enctype="multipart/form-data">
                @csrf
              <div class="box-body">
                <div class="form-group">
                  <label for="judul">Kegiatan</label>
                  <input type="text" class="form-control{{ $errors->has('judul') ? ' is-invalid' : '' }}" id="judul" name="judul" value="{{ old('judul') }}">
                  @if ($errors->has('judul'))
                ...
                <div class="form-group">
                  ...
                  <textarea id="desc" name="desc" class="form-control{{ $errors->has('desc') ? ' is-invalid' : '' }}">{{ old('desc') }}</textarea>
                    @if ($errors->has('desc'))
                        <span class="invalid-feedback" role="alert">
